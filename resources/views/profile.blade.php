...
<body>
    ...
    <div class="text-title" style="text-align: center;">My Profile</div>
    <hr class="col-1 hr-modified">
    <div class="leaderboard-table">
        <table class="profile-table profile">
            <tr>
                <td><b>Nama</td>
    ...
    <div class="text-title" style="text-align: center;">Recent Matches</div>
    <hr class="col-1 hr-modified">
    <div class="leaderboard-table recent-match">
        <table class="table">
            <tr>
                <th>Time</th>
                <th>Total Answers</th>
